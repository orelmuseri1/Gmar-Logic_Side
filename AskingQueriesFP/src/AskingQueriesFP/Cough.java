...
public class Cough extends BasicAlert {
	String area;
	String type;

	public Cough(int childID, String level, String alertTime, String alertDate, String actionNeeded,String area,String type) {

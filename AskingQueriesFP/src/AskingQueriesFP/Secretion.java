...
public class Secretion extends BasicAlert {
	String area;
	String type;

	public Secretion(int childID, String level, String alertTime, String alertDate,String actionNeeded,String area,String type) {
